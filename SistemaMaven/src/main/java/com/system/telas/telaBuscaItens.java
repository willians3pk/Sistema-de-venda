...
public class telaBuscaItens extends javax.swing.JFrame {

    List<Items> items;
    TelaVenda tela;
    
    public telaBuscaItens() {
        initComponents();
        carregaCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaBuscaItens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaBuscaItens().setVisible(true);
            }
        });
    }
