 ...
 * @author user
 */
public class TelaEditarVenda extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 230, 1100, 330);
        ...
        jPanel2.add(jtotalVendas);
        jtotalVendas.setBounds(960, 580, 150, 40);

        jLabel7.setFont(new java.awt.Font("Ubuntu", 0, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 3, 0));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("TELA ADMINSTRADOR VENDAS");
        jPanel2.add(jLabel7);
        ...
        jPanel2.add(btn_gerarRelatorio);
        btn_gerarRelatorio.setBounds(10, 80, 130, 30);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 10, 1120, 630);
        ...
        try {
            for (Venda venda : vendas) {
                if (venda.getIdvenda().equals(tabelaVendas.getValueAt(linha, 0))) {
                    TelaDetalheVenda dv = new TelaDetalheVenda();
